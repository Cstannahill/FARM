        ...
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <Link to="/enterprise" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
                Enterprise
              </Link>
          ...
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="sm" asChild className="hidden sm:flex">
              <a href="https://github.com/farm-framework/farm" target="_blank" rel="noopener noreferrer">
          ...
          <div className="grid gap-8 md:grid-cols-4">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                The modern full-stack framework for building production-ready applications with FastAPI, React, and MongoDB.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><a href="https://github.com/farm-framework/farm" className="hover:text-foreground transition-colors">GitHub</a></li>
