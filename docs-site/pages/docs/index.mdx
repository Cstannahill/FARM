...
Perfect for AI-assisted development, vector databases, and offline reference:

<Card className="my-6 border-primary/20 bg-gradient-to-r from-primary/5 to-primary-accent/5">
...
<div className="flex items-start gap-4">
  ...
  <div className="flex-1">
    <h3 className="text-lg font-semibold mb-2">AI-Optimized Documentation Bundle</h3>
    <p className="text-muted-foreground mb-4">
      Download the complete FARM Framework documentation as a structured ZIP file, 
      optimized for use with AI assistants, vector databases, RAG systems, and plugin development.
    </p>
    ...
    <div className="mt-3 text-xs text-muted-foreground">
      Includes: Complete docs, API reference, examples, metadata • Format: Clean Markdown • Size: ~2MB
    </div>
...
<Note>
  **New to FARM?** Start with our [Getting Started
  guide](/docs/getting-started/) to build your first application in under 10
  minutes.
</Note>
