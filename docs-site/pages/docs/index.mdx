...
<Card className="my-8">
<CardContent>
Welcome to the FARM documentation. A modern, AI-first full-stack framework that bridges React/TypeScript frontends with Python/FastAPI backends, optimized for AI/ML workloads.
</CardContent>
</Card>
...
<FeatureList features={[
  {
    ...
    description: "Built-in GPU support, model inference, and ML pipeline integration with seamless provider switching",
    icon: "🤖"
  },
  {
    title: "Type-Safe Full-Stack", 
    description: "Automatic client generation and end-to-end type safety from database to frontend",
    icon: "🛡️"
  },
  {
    title: "Modern Tooling",
    description: "Vite-powered frontend, FastAPI backend, intelligent hot-reload, and unified CLI",
    icon: "⚡"
  },
  {
    title: "Production Ready",
    description: "Enterprise-grade performance, security, scalability, and deployment options",
    icon: "🚀"
  }
]} />
...
<Callout type="tip" title="Local AI Development">
  FARM includes Ollama integration for zero-cost, offline AI development. Models are automatically downloaded and managed for you.
</Callout>
...
<p className="text-sm text-muted-foreground mb-4">Automatic type generation, API routes, and React hooks</p>
...
<p className="text-sm text-muted-foreground mb-4">Extend functionality with official and community plugins</p>
...
<p className="text-sm text-muted-foreground mb-4">Docker, cloud platforms, and production optimization</p>
...
[Join Discord →](https://discord.gg/farm-framework)
</CardContent>
</Card>
...
[GitHub Issues →](https://github.com/farm-framework/farm/issues)
</CardContent>
</Card>
...
<Note>
**New to FARM?** Start with our [Getting Started guide](/docs/getting-started) to build your first application in under 10 minutes.
</Note>