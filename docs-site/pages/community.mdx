...
**Discord Server:** [Join the FARM Discord](https://discord.gg/farm-framework)  
**Active Channels:**
...
**GitHub Repository:** [farm-framework/farm](https://github.com/farm-framework/farm)  
**Ways to contribute:**
...
All community members are expected to follow our [Code of Conduct](https://github.com/farm-framework/farm/blob/main/CODE_OF_CONDUCT.md).
